...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"google_oauth":                system_setting.GetGoogleOAuthSettings().Enabled,
		"google_client_id":            system_setting.GetGoogleOAuthSettings().ClientId,
		...
		// Keep display_in_currency for existing API clients alongside the richer type.
