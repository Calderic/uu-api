...
**File**: `web/src/features/system-settings/models/model-pricing-sheet.tsx`
...
**Files**: `service/log_info_generate.go`, `web/src/features/usage-logs/lib/format.ts`
...
| Frontend editor | `web/src/features/system-settings/models/model-pricing-sheet.tsx` |
| Frontend display | `web/src/features/pricing/lib/dynamic-price.ts`, `web/src/features/pricing/lib/billing-expr.ts` |
| Model detail | `web/src/features/pricing/components/dynamic-pricing-breakdown.tsx` |
| Log display | `web/src/features/usage-logs/lib/format.ts`, `web/src/features/usage-logs/components/columns/common-logs-columns.tsx` |
