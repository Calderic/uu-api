...
export const splitAuthLayoutClasses = {
  root: 'bg-auth-backdrop flex min-h-svh items-center justify-center p-3 sm:p-6 lg:p-8',
  shell:
    'bg-auth-panel text-auth-panel-foreground ring-auth-border grid w-full max-w-[80rem] overflow-hidden rounded-[1.75rem] shadow-2xl ring-1 lg:min-h-[min(52rem,calc(100svh-4rem))] lg:grid-cols-[1.04fr_0.96fr]',
